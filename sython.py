...
async def _(event):
        ...
        await sython.send_message('@zmmbot', 'جاري التجميع بواسطة | الدولة TEAM')
        channel_entity = await sython.get_entity(bot_username)
...
async def _(event):
        ...
        await sython.send_message('@xnsex21bot', 'جاري التجميع بواسطة | الدولة TEAM')
        channel_entity = await sython.get_entity(bot_usernamee)
...
async def join_channel():
    try:
        await sython(JoinChannelRequest("@M_6_Qn"))
    except BaseException:
        pass
